    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            <?php
                ...
                //$query .= "WHERE posts.post_user = $user_id ";
                ...
                while($row = mysqli_fetch_assoc($select_all_posts_query)){
                    ...
                    if(!empty($user_firstname) && !empty($user_lastname)){
                        echo "<td><a href='posts.php?source=filter_posts&user={$post_user}'>" . $user_firstname . " " . $user_lastname . "</a></td>";
                    } else {
                        echo "<td><a href='posts.php?source=filter_posts&user={$post_user}'>{$username}</a></td>";
                    }
